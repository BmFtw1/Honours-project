...
# lemmatise every token within a set of tokenised value
...
def response(user_response):
    ...
    flat.sort()
    # Get the most similar score to the users responses
    req_tfidf = flat[-2]
    if req_tfidf == 0:
...
def user_processing(user_response):
    user_response = user_response.lower()
